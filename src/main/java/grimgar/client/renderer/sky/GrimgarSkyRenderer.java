...
public class GrimgarSkyRenderer extends ModifiedSkyRenderer{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		generateSky2();
		generateStars();
		renderSky(partialTicks, 0, world, mc);
	}
	...
	@Override
	public void renderStars(BufferBuilder bufferBuilder) {
	...
	@Override
	public void renderSky(BufferBuilder bufferBuilder, float posY, boolean reverseX) {
		int i = 64;
        int j = 6;
        bufferBuilder.begin(7, DefaultVertexFormats.POSITION);
	...
	@Override
	public void renderSky(float partialTicks, int pass, WorldClient world, Minecraft mc) {
		
		TextureManager renderEngine = this.renderEngine(mc);
